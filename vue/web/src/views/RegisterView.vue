<template>
    <div class="LoginView">
        ...
        <button @click="logins" id="unbtn">注册</button>
        <router-link to="/login">
            <p class="resiger">登录</p>
        </router-link>
        <div class="other">
            <div>
                <span></span>
...
export default {
    name: 'LoginView',
    mounted() {
        this.$store.commit('setregisterdatas')
    },
    data() {
        return {
            userShow: true,
...
.LoginView>div:nth-of-type(1) {
    margin-top: 3rem;
}

.LoginView>div:nth-of-type(2) {
    margin-top: 1.8rem;
    position: relative;
}
...
.LoginView>div>input::placeholder {
    color: #8d8d8d;
}
...
.LoginView>div:nth-last-of-type(1) {
    width: 24rem;
    height: 9.6rem;
